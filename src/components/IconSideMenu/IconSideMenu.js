...
const IconSideMenu = ({isOpen}) => {
  return (
    <>
      <div className={`bg-black fixed text-3xl text-white flex items-center pt-16 flex-col h-full top-16 left-0 p-4 rounded-md cursor-pointer translate duration-150 ${isOpen ? "translate-x-0": "-translate-x-32"}  w-20`}>
